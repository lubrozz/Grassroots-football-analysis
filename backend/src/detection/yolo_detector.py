...
class YoloDetector:
    def __init__(self):
        self._model = YOLO("yolov8n.pt")  # Load a pre-trained YOLO model
        self._confidence_threshold = 0.3  # Set a confidence threshold for detections
        
    def detect(self, frame: np.ndarray) -> list[Detection]:
        results_any = list(self._model(frame, verbose=False))  # Run detection on the frame
